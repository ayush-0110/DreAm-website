...
signup.addEventListener('click',()=>{
    ...
    document.getElementById('bt33').style.pointerEvents='none';
    document.getElementById('bt33').classList.remove("btn-primary");
    ...
    otpn.addEventListener('keyup',()=>{
        ...
        if(num.length>=4)
        {
        document.getElementById('bt33').style.pointerEvents="auto"
        // document.getElementById('bt3').style.background='blue';
        document.getElementById('bt33').classList.add("btn-primary");
    }
    else{
        document.getElementById('bt33').classList.remove("btn-primary");
        document.getElementById('bt33').style.pointerEvents="none"}
    ...
    // })
    document.getElementById('bt33').addEventListener('click',()=>{
        otpn=document.getElementById('otp');
        otpn=otpn.value;
        // console.log(otpn);
        // console.log(otpn.value);
        if(otpn==OTP&&OTP!='')
        {
            ...
            document.getElementById('invotp').style.display='flex';
            setTimeout(() => {
                document.getElementById('invotp').style.display="none"
...
login.addEventListener('click',()=>{
    ...
    document.getElementById('forgotbtn').addEventListener('click',()=>{
        ...
        document.getElementById('forgotverif').style.display='flex';
        ...
        Email.send({
            ...
            otpforgot.addEventListener('keyup',()=>{
                ...
                document.getElementById('bt55').style.pointerEvents="auto"
                // document.getElementById('bt3').style.background='blue';
                document.getElementById('bt55').classList.add("btn-primary");
                
            }
            else{
                document.getElementById('bt55').style.pointerEvents="none"
                document.getElementById('bt55').classList.remove("btn-primary");
                }
        ...
        document.getElementById('bt55').addEventListener('click',()=>{
            otpforgot=document.getElementById('otpforgot').value;
            // console.log(otpforgot)
            // console.log(otpforgot.value)
            if(OTP==otpforgot&&OTP!=''){

                document.getElementById('forgotverif').style.display="none"
                document.getElementById('forgo').style.display="flex"
            }
            else
            {

                document.getElementById('invotp_forgot').style.display="flex"
                setTimeout(() => {
                    document.getElementById('invotp_forgot').style.display="none"
